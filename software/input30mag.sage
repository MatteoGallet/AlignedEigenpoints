...
print(S.ideal(m8).saturation(u1*u2*v1*v2))
...
print(M1*vector([l1*dCf]+krm+[l2*dCf]))
...
## Questa retta e' la retta passante per P1 e ortogonale alla retta
...
## condition of alignment between P2, P4, Prt. gives w1 = 0:
det(matrix([P2, P4, Prt])).factor()
