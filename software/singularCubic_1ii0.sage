...
## P1 on Ciso, more precisely, P1 = (1, ii, 0)
## The file singularCubic_100.sage contains the case P1 = (1, 0, 0).
## THE CONCLUSION OF THE COMPUTATIONS IN THIS FILE IS THAT P1
## CANNOT BE SINGULAR.
...
print("A long conmputation of a Groebner basis.")
...
print("End of computation of the Gr basis")
...
print("Computation of squarefree polynomials")
print("About 2,5 sec")
sleep(1)
ttA = cputime()
...
## The final ideal is (1), so P1 cannot be singular.

assert(sgJ7 == S.ideal(1))

print(sgJ7 == S.ideal(1))

## CONCLUSION: IN A V-CONFIGURATION THE POINT P1 CANNOT BE SINGULAR.