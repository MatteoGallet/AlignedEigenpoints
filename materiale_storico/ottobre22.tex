...
\end{prop}
\begin{proof}
  Under our hypotheses, $P_5$, $P_6$ and $P_7$ cannot be alligned. 
  ...
  are alligned, which is not possible hence, necessarily,
...
\end{array}
\]
which are alligned according to configuration $(5)$.
