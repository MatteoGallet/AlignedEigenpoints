...
\textbf{(CITARE \cite{Ottaviani24})}
 ...
 In the present paper, we focus on the geometry of eigenschemes of $3\times 3 \times 3$ symmetric tensors, that is the case $n=2$ and $d=3$. By \Cref{lem:nonempty}, the general such tensor
