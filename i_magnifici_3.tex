...
%% le formule realtive a P6 e P7 nelal configurazione (5).
%% Manca ancora un analogo file per il caso (8).
...
$\scl{P_1 \times P_6}{P_2\times P_5}=0$
(i.e.\ $P_1+P_6$ and $P_2+P_5$ are orthogonal).
...
$P_6 = s_{11}s_{15}P_3-2s_{13}s_{15}P_1+s_{11}s_{13}P_5$ and
