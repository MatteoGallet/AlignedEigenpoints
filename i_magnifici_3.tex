...
\label{positive_dim}
    In this section we consider positive dimensional eigenschemes. By a result in \cite[...]{BGV}, an eigenscheme cannot be of pure dimension $1$, and the possible $1$-dimensional components are of degree $1$ or $2$. In wha follows we shall determine the degree of the
...
otherwise the $h_i$ would be linearly dependent, so the $h_i$ would belong to a pencil, which is a contradiction (giustificare).
