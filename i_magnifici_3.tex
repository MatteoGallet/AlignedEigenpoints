...
\end{prop}
\begin{proof}
Notebook \texttt{proposition-three\_aligned\_plus\_one} shows that the condition imposed by the vanishing of all order $8$ minors of $\Phi(P1, P2, P3, P4)$ is equivalent to the statement.
\end{proof}
