...
We conclude this section by recalling the notion of \emph{Geiser map} and linking the locus it contracts with aligments of eigenpoints.
...
eigenpoints, we shall charaterize the cubics $C = V(f)$ which have a line
in $\Eig{f}$ and, finally, we shall prove that the polynomials $f$
...
\end{equation}
then, the points of the two tangent lines to $\iso$ in~$P_1$ and~$P_2$
are eigenpoints of~$C(r)$.
\end{lemma}
\begin{proof}
