...
b_5, a_6,a_7,a_8,a_9),
$$
where $b_i=b_i (P_1,P_2,a_6,a_7,a_8,a_9)$ are suitable rational functions. In particular we have an
injective morphism
$\alpha : \sV \times \p^3 \to \sL$, and it is simple to check that it is dominant. The claim follows.
