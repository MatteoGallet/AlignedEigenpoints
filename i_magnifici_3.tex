...
$T = \sum _{i=0}^n v_i ^{\otimes d}$ with $v_0 \ dots , v_n$ an orthogonal family; see \cite{Rob, BDHE}
...
It is not difficult to see via a symbolic computation that it is not possible to have that all the order~$4$ minors of $\Phi(P_1, P_2, P_3)$ are zero.
\end{proof}
