...
In general, a cubic having eigenpoints $P_1, \dots, P_5$ in a $V$-configuration satisfying \Cref{rk8_1} has the two alignments $(P_1, P_2, P_3)$ and $(P_1, P_4, P_5)$ in the eigenscheme; in particular, it does not have the collinearity $(P_1, P_6, P_7)$. Since \Cref{rk8_1} implies $\delta_2(P_1, \dots, P_5) = 0$, we see
