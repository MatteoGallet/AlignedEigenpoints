...
\begin{rmk} \textbf{(@@ si puo' dire meglio, usando le derivate parziali @@)}
...
claim that we can greatly simplify
the computations.
...
\end{itemize}
\end{prop}
\textbf{(@@ forse meglio mettere solo questa prop. e non la precedente @@)}
