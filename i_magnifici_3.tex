...
\end{prop}
\begin{proof}
Notebook \texttt{proposition-three\_distinct\_ranks} gives that $\Phi(P_1, P_2, P_4)$ has rank~$5$ if and only if $P_1, P_2, P_4$ are aligned and, according to \Cref{proposition:three_aligned_ranks},
