...
\begin{prop}
\textbf{(AGGIUNGERE IPOTESI SU RANGO NON 8)} Suppose we have $7$ points which are eigenpoints of a cubic and are
...
$s_{12} = s_{14}=s_{16}=0$. In particular, we see that $P_1 = P_2 \times P_4$. It is
immediate to verify that the line $P_2\vee P_4$ is orthogonal to the
lines $P_1\vee P_2$, $P_1\vee P_4$ and $P_1\vee P_6$, and this proves the last claim
of the proposition.
\end{proof}
