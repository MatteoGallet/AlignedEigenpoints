...
\Cref{conditions} begin our analysis by examining what conditions on the space of ternary cubics are imposed by the existence of aligned eigenpoints. In particular, three kinds of conditions, named~$\delta_1$, $\bar{\delta}_1$, and~$\delta_2$, emerge and play a prominent role in describing configurations of two triples of aligned eigenpoints that share a point, here called $V$-configurations.
...
In the second case, $\sigma(P_1, P_2) = 0$ and $P_2\in \iso$, so the line~$P_1 \vee P_2 \vee P_3$ is tangent to~$\iso$ in~$P_2$
...
From the matrix~$H$ it is moreover possible to construct the three minors of Equation (3), indeed
...
the points $P_1, P_6, P_7$ are collinear and $r$ is orthogonal to~$P_3 \vee P_5$.
