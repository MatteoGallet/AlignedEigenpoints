...
\textbf{SPIEGAZIONE DI VALENTINA}

We know that $G_1, G_2, G_3$ admit the syzygy $z G_1 - y G_2 + x G_3 = 0$.
Then, due to the exactness of the Koszul complex of $(x,y,z)$ (see Eisenbud),
...
Beorchia-Galuppi-Venturello proved that if $E$ is zero-dimensional and reduces,
then in the ideal of~$E$ there exists a unique triple of generators of the form
%
\[
 \left(
 \begin{array}{ccc}
...
Consider the Laguerre map $\gamma \colon \p^2 \setminus E \longrightarrow \p^2 = \p(\left\langle G_1, G_2, G_3 \right\rangle^\vee)$.
By construction, we have $\gamma$ maps $P$ to the pencil of cubics passing through $E$ and $P$.
...
\textbf{Conclusione spiegazione di Valentina}
