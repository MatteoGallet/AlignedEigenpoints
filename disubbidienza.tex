...
of~\Cref{sezione_delta_2}, hence we can do the same construcion explained
...
the proof of~\Cref{three_d_three_alinments}.

Concerning \Cref{prop:d2_6allin}, we start the computations as in the
...
In order to get the proof of~\Cref{prop:rk8_2A} and~\Cref{prop:rk8_2B}
