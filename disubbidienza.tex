...
the $V$-configuration are tangent to $\iso$}).


Let us start with the first case.

The three conditions~(\ref{rk8_1}) give (using (\ref{rmk_delta_1})
and (\ref{rmk_delta_2})) give that $P_1$ and
$P_2$ can be chosen in an arbitrary way, $P_4$ in the $\mathbb{P}^1$
space of points orthogonal to $s_{11}P_2-s_{12}P_1$, while $P_3$
and $P_5$ are determined by:
$P_3 = (s_{12}^2+s_{11}s_{12})P_1-2s_{11}s_{12}P_2$ and 
$P_5 = (s_{12}^2+s_{11}s_{12})P_1-2s_{11}s_{14}P_4$
...
Moreover, from~\Cref{proposition:P1_space
