...
The points which satisfy the first condition can be obtained
...
Moreover, we have
\[
\overline{\delta}_1(P_1, P_2, P_3) = 2s_{11}s_{12}u_1 + s_{12}^2u_2
+ s_{11}s_{22}u_2$ 
\]
and a similar expression for $\overline{\delta}_1(P_1, P_4, P_5)$
(where, as usual $s_{ij}$ denotes $\scl{P_i}{P_j}$),
hence $P_3 = (s_{12}^2+s_{11}s_{22})P_1-2s_{11}s_{12}P_2$ and
$P_5 = (s_{14}^2+s_{11}s_{44})P_1-2s_{11}s_{14}P_2$, therefore
the configuratioin can be parametrized by (an open subset) of
$\mathbb{P}^2\times \mathbb{P}_2\times \mathbb{P}^1$.




I punti che soddisfano la condizione 3, punto 2, si trovano:\\
assegnando P1, P2, P4 arbitrari e P3 su P1+P2 con \\
$u_1 = s12^2 + s11*s22$,  $u_2 = -2*s11*s12$\\
e P5 su retta P1+P4 con simili coefficienti. Sono $P^2xP^2xP^2$\\
La famiglia di cubiche ha dim 1 e sono, pare dagli esempi, singolari in P1
