...
\begin{prop}
\label{proposition:terzo_allineammento}
...
\verb+molti altri file via via indicati nei commenti di latex+
In this Section we want to study the possible configurtations of
points for cubic with a $V$-configuration of points $P_1, \dots, P_5$
which satisfy the condition $\rk \Phi(P_1, \dots, P_5) = 8$. According
to~\Cref{proposition:rank_V}, we have to distinguish two cases, the two
lines of the $V$-configuration are tangent to $\iso$, or
...
hence the problem of considering all the possible further
...
computational tools. In particular, we get:

\begin{lemma} Suppose that among the points $P_1, \dots, P_5$ of a
$V$-configuration which satisfy condition of~\Cref{proposition:rank_V}
